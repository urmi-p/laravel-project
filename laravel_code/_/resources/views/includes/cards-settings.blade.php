<div class="">
    ...
    <div @class([
        'd-lg-block',
        'navbar-collapse collapse' => !request()->routeIs('user.settings'),
    ])>
        ...
        <div class="card shadow-sm card-settings mb-3">
            ...
            <div class="list-group list-group-sm list-group-flush">
                ...
                <small
                    class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.account') }}</small>
                ...
                @if (auth()->user()->verified_id == 'yes')
                    <a href="{{ url('settings/conversations') }}" @class([
                        'list-group-item list-group-item-action d-flex justify-content-between',
                        'active' => request()->is('settings/conversations'),
                    ])>
        ...
        @if ($settings->live_streaming_private == 'on')
            ...
            <div class="card shadow-sm card-settings mb-3">
                ...
                <div class="list-group list-group-sm list-group-flush">
                    ...
                    <small
                        class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.live_streaming_private') }}</small>
        ...
        <div class="card shadow-sm card-settings mb-3">
            ...
            <div class="list-group list-group-sm list-group-flush">
                ...
                <small
                    class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.subscription') }}</small>
        ...
        <div class="card shadow-sm card-settings mb-3">
            ...
            <div class="list-group list-group-sm list-group-flush">
                ...
                <small
                    class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.privacy_security') }}</small>
        ...
        <div class="card shadow-sm card-settings mb-3">
            ...
            <div class="list-group list-group-sm list-group-flush">
                ...
                <small
                    class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.payments') }}</small>
        ...
        @if (
            ...
            <div class="card shadow-sm card-settings">
                ...
                <div class="list-group list-group-sm list-group-flush">
                    ...
                    <small
                        class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.shop') }}</small>
