<div class="col-md-{{ request()->routeIs('user.settings') ? '12' : '6' }} col-lg-{{ request()->routeIs('user.settings') ? '12' : '3' }} mb-3">
	...
	<div @class(['d-lg-block', 'navbar-collapse collapse' => !request()->routeIs('user.settings')])>
		<!-- Start Account -->
