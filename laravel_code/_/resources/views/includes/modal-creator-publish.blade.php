				...
				<div class="card bg-white shadow border-0">
					<div class="card-body px-lg-5 py-lg-5 position-relative">
						<div class="mb-4 position-relative">
							...
							<small data-dismiss="modal" class="btn-cancel-msg" aria-label="{{ __('general.close') }}">
						...
						<button type="button" class="card choose-type-sale choose-type-sale-btn creator-publish-live-option mb-0 w-100 text-left btnCreateLive btn-reset" data-dismiss="modal">
							<div class="card-body">
