    ...
    <div class="pb-0">
      <div class="media">
        ...
        <div class="media-body position-relative">
          <textarea class="form-control textareaAutoSize emojiArea mentions" name="description" id="updateDescription" data-post-length="{{$settings->update_length}}" rows="4" cols="40" placeholder="{{__('general.share_thoughts')}}"></textarea>
