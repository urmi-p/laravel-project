...
<div class="card msg-inbox border-bottom m-0 rounded-0">
	<div class="list-group list-group-sm list-group-flush rounded-0">
		...
		<a href="javascript:;"
			class="item-chat list-group-item list-group-item-action text-decoration-none p-4">
			<div class="media">
		...
		class="item-chat list-group-item list-group-item-action text-decoration-none p-4 @if ($msg->status == 'new' && $msg->sender->id != auth()->id()) font-weight-bold unread-chat @endif  @if (request()->id == $msg->remitter()->id) active disabled @endif">
			<div class="media">
