...
<div class="card msg-inbox m-0 rounded-0 w-100">
	<div class="list-group list-group-sm list-group-flush rounded-0 w-100">
		@if (!$msg->remitter())
		<a href="javascript:;"
			class="item-chat list-group-item list-group-item-action text-decoration-none p-0">
			<div class="media">
				<div class="media-left mr-3 position-relative user-offline">
					<img class="media-object rounded-circle"
						src="{{ Helper::getFile(config('path.avatar').$settings->avatar) }}" width="50" height="50">
				</div>
				<div class="media-body overflow-hidden">
					<div class="d-flex justify-content-between align-items-center">
						<h6 class="media-heading mb-2 text-truncate">
							<em>{{ __('general.user_unavailable') }}</em>
						</h6>
		...
		@else
		<a
			href="{{ $msg->remitter()->status == 'disabled' ? 'javascript:;' : url('messages', [$msg->remitter()->id, $msg->remitter()->username])}}"
			class="item-chat list-group-item list-group-item-action text-decoration-none  @if ($msg->status == 'new' && $msg->sender->id != auth()->id()) font-weight-bold unread-chat @endif  @if (request()->id == $msg->remitter()->id) active disabled @endif">
			<div class="media">
				@if ($msg->remitter()->status == 'disabled')
				<div class="media-left mr-3 position-relative">
					<img class="media-object rounded-circle" src="{{Helper::getFile(config('path.avatar').$settings->avatar)}}" width="50" height="50">
				</div>
				@else
				...
				<div class="media-body overflow-hidden">
					<div class="d-flex justify-content-between align-items-center">
						<h6 class="media-heading mb-2 text-truncate">
							...
							{{ $msg->remitterName() }}
							@endif
							@if ($msg->remitter()->verified_id == 'yes' && $msg->remitter()->status == 'active')
					...
					<p class="text-truncate m-0">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-coin mb-1" viewBox="0 0 16 16">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-gift mb-1" viewBox="0 0 16 16">
							<path d="M3 2.5a2.5 2.5 0 0 1 5 0 2.5 2.5 0 0 1 5 0v.006c0 .07 0 .27-.038.494H15a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 1 14.5V7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h2.038A3 3 0 0 1 3 2.506zm1.068.5H7v-.5a1.5 1.5 0 1 0-3 0c0 .085.002.274.045.43zM9 3h2.932l.023-.07c.043-.156.045-.345.045-.43a1.5 1.5 0 0 0-3 0zM1 4v2h6V4zm8 0v2h6V4zm5 3H9v8h4.5a.5.5 0 0 0 .5-.5zm-7 8V7H2v7.5a.5.5 0 0 0 .5.5z" />
						</svg>

						@if ($msg->message == '') {{ __('general.gift') }} @endif
