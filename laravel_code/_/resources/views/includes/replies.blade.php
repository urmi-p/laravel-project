    ...
    <div class="media-body">
      ...
      @endif
        ...
        @if ($reply->gif_image)
          ...
          <div class="w-100 d-block mt-2"><img class="rounded" src="{{ $reply->gif_image }}" width="200"></div>
      ...
      <span class="likeComment c-pointer float-right pulse-btn" data-id="{{$reply->id}}">
        ...
        <i class="@if (auth()->check() && $reply->likes->where('user_id', auth()->id())->first()) bi-hand-thumbs-up-fill text-red mr-1 @else bi-hand-thumbs-up-fill mr-1 @endif"></i>
