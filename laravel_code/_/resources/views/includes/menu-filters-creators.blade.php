@if (!request()->get('q') || (request()->get('q') && strlen(request()->get('q')) <= 2))
    ...
    <button type="button" class="btn-menu-expand btn btn-primary btn-block mb-4 mt-5 d-lg-none brd-8" type="button"
    ...
    <div class="navbar-collapse collapse d-lg-block" id="navbarFilters">
        <div class="btn-block mb-3 myhover_btn">
            <span>
    ...
    @if ($settings->search_creators_genders)
        ...
        <div class="modal fade" id="filterGendersAge" tabindex="-1" role="dialog" aria-labelledby="modal-form"
            aria-hidden="true">
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <select name="gender" class="form-control custom-select input-pl report-modal-select">
                                                    ...
                                                    @foreach ($genders = explode(',', $settings->genders) as $gender)
                                                        <option
                                                            @if (request('gender') == $gender) selected="selected" @endif
                                                            value="{{ $gender }}">{{ __('general.' . $gender) }}
                                                        </option>
                                                    @endforeach
