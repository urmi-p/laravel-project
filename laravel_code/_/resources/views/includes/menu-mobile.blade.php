<div class="menuMobile d-md-none">
	<ul class="list-inline d-flex bd-highlight m-0 text-center">
		...
		{{-- <li class="flex-fill bd-highlight">
			<a href="{{auth()->user()->verified_id == 'yes' ? url('dashboard') : url('settings/verify/account')}}" class="p-3 btn-mobile position-relative">
				<i class="fas fa-chart-line icon-navbar"></i>
			</a>
		</li> --}}
