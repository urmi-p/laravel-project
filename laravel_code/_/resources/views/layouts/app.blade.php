...
<head>
  ...
  @else
    ...
    <meta property="og:image" content="{{ route('social.share-image', ['v' => '9']) }}" />
    <meta property="og:image:secure_url" content="{{ route('social.share-image', ['v' => '9']) }}" />
    ...
    <meta name="twitter:image" content="{{ route('social.share-image', ['v' => '9']) }}" />
