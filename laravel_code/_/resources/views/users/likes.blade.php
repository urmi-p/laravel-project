  ...
  <div class="container-fluid pt-lg-5 pt-2">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 p-0 second wrap-post">
        ...
        <div class="my-5 text-center no-updates no-updates main-no-updates">
          <div class="sub-no-updates">
            <span class="btn-block mb-3">
              <i class="far fa-heart ico-no-result bg_black"></i>
            </span>
            <h4 class="font_weight_400 font_size_18">{{trans('general.no_likes')}}</h4>
          </div>
        </div>
