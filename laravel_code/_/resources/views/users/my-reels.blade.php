      ...
      <div class="col-md-12 col-lg-9 mb-5 mb-lg-0">
        <div class="row mb-sm">
          <div class="col-lg-8">
            ...
            <p class="mt-0 font_weight_400 fs-14">{{__('general.my_reels_subtitle')}}</p>
            <div class="my-2">
                        ...
                        <tr>
                          <td>
                            @if ($reel->media)
                              @php
                                if ($reel->media) {
                                    if ($reel->media->bunny_video_id) {
                                        $image = $reel->media->video_poster;
                                    } else {
                                        $image = route('resize', [
                                            'path' => 'reels',
                                            'size' => 35,
                                            'file' => $reel->media->video_poster
                                        ]) . '?crop=fit';
                                    }
                                } else {
                                    $image = Helper::getFile(config('path.avatar') . $reel->user->avatar);
                                }
                              @endphp
                              <img src="{{ $image }}" width="35" height="35" class="rounded mr-2">
                            @endif
              ...
              <div class="my-5 text-center main-no-updates">
                <div class="sub-no-updates">
                  <span class="btn-block mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="align-bottom border-0 ico-no-result bg_black"  fill="currentColor" width="20" height="20" viewBox="0 0 50 50">
                  ...
                  @else
                    <h4 class="font_weight_400 font_size_18">{{__('general.not_reels_created')}}</h4>
