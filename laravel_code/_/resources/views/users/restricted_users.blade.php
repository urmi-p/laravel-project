    ...
    <div class="container-fluid pt-lg-5 pt-2">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
          <div class="row mb-sm">
            <div class="col-lg-8">
              <h2 class="mb-0 font-montserrat font_weight_700 fs-24 pb-3"><i class="feather icon-slash mr-2"></i> {{trans('general.restricted_users')}}</h2>
              <p class="lead mt-0 font_weight_400 fs-14">{{trans('general.info_restricted_users')}}</p>
            </div>
          </div>
          ...
          <div class="my-5 text-center no-updates main-no-updates">
            <div class="sub-no-updates">
              <span class="btn-block mb-3">
                <i class="feather icon-slash ico-no-result bg_black"></i>
              </span>
