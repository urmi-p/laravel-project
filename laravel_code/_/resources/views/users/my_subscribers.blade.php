    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
        ...
        <div style="max-width: 600px; margin: 20px auto; font-family: sans-serif;">
          ...
          <!-- Dummy Card 1 -->
          <div style="background-color: #1e1e1e; color: #fff; border: 1px solid #333; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; row-gap: 10px;">
              ...
              <span style="display: flex; align-items: center; gap: 5px; color: #2ecc71;">
                <span style="width: 10px; height: 10px; border-radius: 50%; background-color: #2ecc71; display: inline-block;"></span>
                Active
              </span>
            </div>
          </div>
          ...
          <div style="background-color: #1e1e1e; color: #fff; border: 1px solid #333; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; row-gap: 10px;">
              ...
              <span style="display: flex; align-items: center; gap: 5px; color: #f1c40f;">
                <span style="width: 10px; height: 10px; border-radius: 50%; background-color: #f1c40f; display: inline-block;"></span>
                Under Review
              </span>
            </div>
          </div>
        ...
        <div class="subscriptions-cards">
          @foreach ($subscriptions as $subscription)
          <div class="card mb-3 bg-dark text-white shadow-sm" style="border-radius: 8px; border: 1px solid #333;">
            ...
            <div class="row">
              ...
              <div class="col-6">{{ $subscription->free == 'yes'? __('general.not_applicable') : __('general.'.$subscription->interval) }}</div>
              ...
              <div class="col-6 d-flex align-items-center">
                ...
                <br>
                <a class="badge badge-pill badge-success text-uppercase mt-1" href="{{ route('cashier.payment', $subscription->last_payment) }}">
                  {{ __('general.confirm_payment') }}
                </a>
                @else
