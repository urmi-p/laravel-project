  ...
  <div class="container-fluid pt-lg-5 pt-2">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
        <div class="row mb-sm">
          <div class="col-lg-8">
            <h2 class="mb-0 font-montserrat pb-3"><i class="feather icon-users mr-2"></i> {{__('users.my_subscribers')}}</h2>
        ...
        <div class="my-5 text-center no-updates main-no-updates">
          <div class="sub-no-updates">
            ...
            <h4 class="font_weight_400 font_size_18">{{__('users.not_subscribers')}}</h4>
          </div>
        </div>
        @endif
      </div><!-- end col-md-6 -->
