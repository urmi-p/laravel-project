    ...
    <div class="container-fluid pt-lg-5 pt-2">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
          <div class="row mb-sm">
            <div class="col-lg-8">
              <h2 class="mb-0 font-montserrat font_weight_700 fs-24 pb-3"><i class="bi-telephone mr-2"></i> {{__('general.audio_call_settings')}}</h2>
          ...
          <form method="POST" action="{{ url()->current() }}">
            @csrf
                <div class="form-group mb-4">
                  <label class="w-100 ">{{__('general.price_audio_call')}} *</label>
                  <div class="input-group mb-2">
                    
                    <div class="input-group-prepend">
                      <span class="input-group-text">{{$settings->currency_symbol}}</span>
                    </div>
                        <input value="{{ auth()->user()->price_audio_call }}" class="form-control form-control-lg isNumber" required name="price_audio_call" autocomplete="off" placeholder="{{__('general.price_audio_call')}}" type="text">
                    </div>
                ...
                <div class="w-100">
                    ...
                    <select name="audio_call_duration" class="form-control custom-select">
