...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <i class="bi-chevron-right me-1 fs-6"></i>
      <span class="text-muted">Instamojo</span>
  </h5>
	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
                ...
                <small class="d-block"><a href="https://instamojo.com/integrations" target="_blank">https://instamojo.com/integrations</a></small>
		          </div>
		        </div>

            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">Auth Token</label>
		          <div class="col-sm-10">
