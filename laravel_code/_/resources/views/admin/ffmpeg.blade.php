...
if (phpversion() < 8.2) {
	echo '<div class="msg-warning">Error: Your PHP version is lower than 8.2+ (You are using: ' . phpversion() . ' )</div>';
	echo '<div>To ensure your security, we recommend that you use a version higher than 8.2.</div>';
	$error++;
} else {
