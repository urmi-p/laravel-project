...
<div class="content">
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">Token Public</label>
		          <div class="col-sm-10">
		            <input value="{{ $data->key }}" name="key" type="password" class="form-control">
								<p class="d-block"><a href="https://app.payku.cl/usuarios/tokenintegracion" target="_blank">https://app.payku.cl/usuarios/tokenintegracion</a></p>
		          </div>
		        </div>
