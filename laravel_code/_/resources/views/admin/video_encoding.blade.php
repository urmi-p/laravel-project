	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input value="{{ env('BUNNY_STREAM_API_KEY') }}" name="bunny_stream_api_key" type="text" class="form-control">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input value="{{ env('BUNNY_STREAM_LIBRARY_ID') }}" name="bunny_stream_library_id" type="text" class="form-control">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input value="{{ env('BUNNY_STREAM_CDN_HOSTNAME') }}" name="bunny_stream_cdn_hostname" type="text" class="form-control">
                <p class="d-block m-0 text-muted">Example: vz-xxxxxxxx.b-cdn.net</p>
              </div>
            </div>

            <div class="row mb-3">
              <label class="col-sm-2 col-form-label text-lg-end">Bunny API Key (Management)</label>
              <div class="col-sm-10">
                <input value="{{ env('BUNNY_API_KEY') }}" name="bunny_api_key" type="text" class="form-control">
                <p class="d-block m-0 text-muted">Required for auto-syncing MP4 fallback and watermark settings.</p>
              </div>
            </div>
                  ...
                  <fieldset class="row mb-3">
                    <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.watermark_position') }}</legend>
                    <div class="col-sm-10">
