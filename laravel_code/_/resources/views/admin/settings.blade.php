...
<div class="content">
	...
	<div class="row">
      ...
      <fieldset class="row mb-4">
        ...
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('custom.hide_comments') }}</legend>

        <div class="col-sm-10">

          <div class="form-check form-switch form-switch-md">

           <input class="form-check-input" type="checkbox" name="hide_comments" @checked($settings->hide_comments) value="1" role="switch">
      ...
      <fieldset class="row mb-4">
        ...
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('custom.hide_total_likes') }}</legend>

        <div class="col-sm-10">

          <div class="form-check form-switch form-switch-md">

           <input class="form-check-input" type="checkbox" name="hide_total_likes" @checked($settings->hide_total_likes) value="1" role="switch">
