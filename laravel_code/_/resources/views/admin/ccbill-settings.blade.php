	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $data->ccbill_accnum }}" name="ccbill_accnum" type="text" class="form-control">
		          </div>
		        </div>

			<div class="row mb-3">
				<label class="col-sm-2 col-form-label text-lg-end">CCBill SubAccount Number ({{ trans('admin.subscriptions') }})</label>
				<div class="col-sm-10">
					<input value="{{ $data->ccbill_subacc_subscriptions }}" name="ccbill_subacc_subscriptions" type="text" class="form-control">
				</div>
				</div>

            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">CCBill SubAccount Number  ({{ trans('general.one_time_payments') }})</label>
		          <div class="col-sm-10">
		            <input value="{{ $data->ccbill_subacc }}" name="ccbill_subacc" type="text" class="form-control">
		          </div>
		        </div>
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $data->ccbill_flexid }}" name="ccbill_flexid" type="text" class="form-control">
		          </div>
		        </div>
		          ...
		          <div class="col-sm-10">
		            <input value="{{ $data->ccbill_salt }}" name="ccbill_salt" type="text" class="form-control">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
					  <input value="{{ $data->ccbill_datalink_username }}" name="ccbill_datalink_username" type="text" class="form-control">
					</div>
				  </div>
				  ...
				  <div class="row mb-3">
					...
					<div class="col-sm-10">
					  <input value="{{ $data->ccbill_datalink_password }}" name="ccbill_datalink_password" type="text" class="form-control">
					</div>
				  </div>
				  ...
				  <fieldset class="row mb-3">
					...
					<div class="col-sm-10">
					  <div class="form-check form-switch form-switch-md">
					   <input class="form-check-input" type="checkbox" name="ccbill_skip_subaccount_cancellations" @if ($data->ccbill_skip_subaccount_cancellations) checked="checked" @endif value="1" role="switch">
					 </div>
					</div>
				  </fieldset>
