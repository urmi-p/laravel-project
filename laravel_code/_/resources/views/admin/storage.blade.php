			...
			<div class="card shadow-custom border-0">
		        ...
		        <div class="row mb-5">
		          ...
		          <div class="col-sm-10">
					...
					<option @if (config('filesystems.default') == 'bunny') selected @endif value="bunny">Bunny</option>
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny API Key</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_API_KEY') }}" name="BUNNY_API_KEY" type="text" class="form-control @error('BUNNY_API_KEY') is-invalid @endif">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Storage Zone</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STORAGE_ZONE') }}" name="BUNNY_STORAGE_ZONE" type="text" class="form-control @error('BUNNY_STORAGE_ZONE') is-invalid @endif">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Storage Password</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STORAGE_PASSWORD') }}" name="BUNNY_STORAGE_PASSWORD" type="text" class="form-control @error('BUNNY_STORAGE_PASSWORD') is-invalid @endif">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Storage Region</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STORAGE_REGION') }}" name="BUNNY_STORAGE_REGION" type="text" class="form-control @error('BUNNY_STORAGE_REGION') is-invalid @endif" placeholder="de">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Pull Zone URL</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_PULL_ZONE_URL') }}" name="BUNNY_PULL_ZONE_URL" type="text" class="form-control @error('BUNNY_PULL_ZONE_URL') is-invalid @endif" placeholder="https://your-pullzone.b-cdn.net">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Stream API Key</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STREAM_API_KEY') }}" name="BUNNY_STREAM_API_KEY" type="text" class="form-control @error('BUNNY_STREAM_API_KEY') is-invalid @endif">

		            <small class="d-block mt-1 text-muted">Used for video streaming (Bunny Stream).</small>
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Stream Library ID</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STREAM_LIBRARY_ID') }}" name="BUNNY_STREAM_LIBRARY_ID" type="text" class="form-control @error('BUNNY_STREAM_LIBRARY_ID') is-invalid @endif">
		          ...
		          <label class="col-sm-2 col-form-label text-lg-end">Bunny Stream CDN Hostname</label>

		          <div class="col-sm-10">

		            <input value="{{ env('BUNNY_STREAM_CDN_HOSTNAME') }}" name="BUNNY_STREAM_CDN_HOSTNAME" type="text" class="form-control @error('BUNNY_STREAM_CDN_HOSTNAME') is-invalid @endif" placeholder="vz-xxxx.b-cdn.net">
