 		          ...
 		          <div class="col-sm-10">
 		            <select name="role" class="form-select">
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="video_calls" @if (isset($permissions) && in_array('video_calls', $permissions)) checked="checked" @endif type="checkbox" id="video_calls">
									<label class="form-check-label" for="video_calls">
										{{ __('general.video_calls') }}
									</label>
								</div>
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="audio_calls" @if (isset($permissions) && in_array('audio_calls', $permissions)) checked="checked" @endif type="checkbox" id="audio_calls">
									<label class="form-check-label" for="audio_calls">
										{{ __('general.audio_calls') }}
									</label>
								</div>
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="age_verification" @if (isset($permissions) && in_array('age_verification', $permissions)) checked="checked" @endif type="checkbox" id="age_verification">
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="moderation_image_video" @if (isset($permissions) && in_array('moderation_image_video', $permissions)) checked="checked" @endif type="checkbox" id="moderation_image_video">
									<label class="form-check-label" for="moderation_image_video">
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="stickers" @if (isset($permissions) && in_array('stickers', $permissions)) checked="checked" @endif type="checkbox" id="stickers">
						...
						<div class="row mb-3">
							<div class="col-sm-10 offset-sm-2">
								<div class="form-check">
									<input class="form-check-input check" name="permissions[]" value="giphy" @if (isset($permissions) && in_array('giphy', $permissions)) checked="checked" @endif type="checkbox" id="giphy">
