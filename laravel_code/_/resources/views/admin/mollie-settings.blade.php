...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <i class="bi-chevron-right me-1 fs-6"></i>
      <span class="text-muted">Mollie</span>
  </h5>
	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
                ...
                <small class="d-block"><a href="https://www.mollie.com/dashboard/developers/api-keys" target="_blank">https://www.mollie.com/dashboard/developers/api-keys</a></small>
		          </div>
		        </div>
