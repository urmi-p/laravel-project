...
<head>
    ...
    <title>{{ $title_site ?? config('app.name') }}</title>
                        ...
                        <td class="logo-wrap">
                            <a href="{{ url('/') }}" target="_blank" rel="noopener">
                                <img src="{{ url('public/img', $settings->logo) }}"
                                    alt="{{ $title_site ?? config('app.name') }}" width="210">
                            </a>
                        </td>
                    </tr>
                </table>
                                            ...
                                            <tr>
                                                ...
                                                <td class="footer-text-cell">
                                                    <p class="footer-about">
                                                        {{ __('emails.footer_about', ['title' => $title_site ?? config('app.name')]) }}
                                                    </p>
                                                    ...
                                                    <p class="copyright">
                                                        &copy; {{ date('Y') }} {{ $title_site ?? config('app.name') }},
                                                        {{ __('emails.rights_reserved') }}<br>
