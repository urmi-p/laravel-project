...
@auth
  ...
  var stripeKey = @if (request()->routeIs('reels.section.*')) false @else "{{ PaymentGateways::where('id', 2)->where('enabled', '1')->whereSubscription('yes')->first() ? env('STRIPE_KEY') : false }}" @endif;
...
.btn-twitter { background-color: #000;  color:#fff !important;  border: 1px solid #FFFFFF33;}
