                        ...
                        g = {
                            ...
                            template: {
                                timelineItem: function (t) {
                                    return '\n            <div class="story previewText '
                                        .concat(!0 === i(t, "seen") ? "seen" : "", '">\n              <a class="item-link" href="')
                                        .concat(i(t, "link"), '">\n                <span class="item-preview">\n <div class="text-story-preview"></div>                 <img lazy="eager" src="')
                                        .concat(
                                            u("avatars") || !i(t, "currentPreview") ? i(t, "photo") : i(t, "currentPreview"),
                                            '" />\n                </span>\n                <span class="info" itemProp="author" itemScope itemType="http://schema.org/Person">\n <img width="24" class="mr-1 rounded-circle border-2" lazy="eager" src="'
                                        )
                                        .concat(i(t, "photo"), '" />                 <strong class="name" itemProp="name">')
                                ...
                                viewerItem: function (t, e) {
                                    return '<div class="story-viewer">\n                    <div class="head">\n                      <div class="left">\n                        '
                                        .concat(
                                            u("backButton") ? '<a class="back d-none">&lsaquo;</a>' : "",
                                            '\n\n                        <span class="item-preview">\n                          <img lazy="eager" class="profilePhoto border-2" src="'
                                        )
                                        .concat(i(t, "photo"), '" />\n                        </span>\n\n                        <div class="info">\n                          <strong class="name verified-story">')
                                        .concat(i(t, "name"), '</strong>\n                          <span class="time">')
                                ...
                                viewerItemBody: function (t, e, n) {
                                    return '<div \n                    class="item itemStory '
                                        .concat(!0 === i(n, "seen") ? "seen" : "", " ")
                                        .concat(e === t ? "active" : "", '"\n                    data-time="')
                                        .concat(i(n, "time"), '" data-type="')
                                        .concat(i(n, "type"), '" data-index="')
                                        .concat(t, '" data-item-id="')
                                        .concat(i(n, "id"), '" data-id-story="')
                                        .concat(i(n, "story"), '"><div class="modal-text-story" style="font-family:')
                                        .concat(i(n, "font"), "; color:")
                                        .concat(i(n, "color"), '" >')
                                        .concat(i(n, "text"), "</div>\n                    ")
                                        .concat(
                                            "video" === i(n, "type")
                                        ...
                                        .concat(
                                            i(n, "linkText")
                                                ? '<span class="tip link" data-text="'
                                                      .concat(i(n, "link"), '" rel="noopener" data-text="_blank">\n                            ')
                            ...
                            var g = a("#zuck-modal-content"),
                                ...
                                I = function (t, e, n) {
                                    ...
                                    (S.className = "story-viewer muted "
                                        ...
                                        o(S.querySelectorAll(".closeStory, .back"), function (t, e) {
